...
class test_users_by_system(unittest.TestCase):

    header = {}
    client = app.test_client()
    url = '/AuthServices/users-by-system'

    def test_method_users_by_system_with_cwid_bayer(self):
    ...
    def test_method_users_by_system_with_email_bayer(self):
        app_id = 'f282375a9c5f4f849e2716d39bf1d627'
    ...
    def test_method_users_by_system_with_cwid_external(self):
        app_id = 'f282375a9c5f4f849e2716d39bf1d627'
        login = 'GAEL'
        ip = '172.30.28.28'
        self.header = set_header()
    ...
    def test_method_users_by_system_with_email_external(self):
        app_id = 'f282375a9c5f4f849e2716d39bf1d627'
    ...
    def test_method_users_by_system_with_email_gigya(self):
        app_id = 'f282375a9c5f4f849e2716d39bf1d627'
    ...
    def test_method_users_by_system_invalid_system(self):
    ...
    def test_method_users_by_system_invalid_login(self):
        app_id = 'f282375a9c5f4f849e2716d39bf1d627'
        login = 'INVALID_LOGIN'
        ip = 'INVALID_IP'
        self.header = set_header()
        ...
        if resp.status_code != 200 and resp.status_code != 401:
            self.fail(f'{resp.status}')
        result: dict = dict(resp.json).get('result')
        # 13 - User without access!
        self.assertTrue(result.get('code') == 13, f'expected code: 13, returned: {result.get("code")}')
